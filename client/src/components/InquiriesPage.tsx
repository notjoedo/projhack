    ...
    <div className="flex-1 p-8 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-subtle">Track your housing applications and group planning</p>
        </div>
            ...
            <div className="space-y-4">
              {sentInquiries.length > 0 ? (
                sentInquiries.map((inquiry) => (
                  <div key={inquiry.id} className="glass rounded-xl p-6 border border-white/20">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        />
                        <div>
                          <h3 className="font-semibold text-gray-900">{inquiry.address}</h3>
                          <p className="text-subtle">Contacted {inquiry.contactedDate}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">${inquiry.price}/month</p>
                        <button 
                ...
                <div className="glass rounded-xl p-12 text-center border border-white/20">
                  ...
                  <p className="text-subtle">Your sent inquiries will appear here</p>
                </div>
              )}
            </div>
          </section>
            ...
            <div className="space-y-4">
              {potentialGroups.length > 0 ? (
                potentialGroups.map((group) => (
                  <div key={group.id} className="glass rounded-xl p-6 border border-white/20">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <img 
                          src={group.image} 
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">${group.price}/month</p>
                        <button 
                ...
                <div className="glass rounded-xl p-12 text-center border border-white/20">
                  ...
                  <p className="text-subtle mb-6">Start connecting with other students to form a group</p>
