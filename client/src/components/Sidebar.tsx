...
export function Sidebar({
  ...
  const navItems = [
    ...
    { id: "inquiries", label: "Inquiries & Groups", icon: MessageSquare },
          ...
          <nav className="space-y-1 flex-1">
            {navItems.map((item) => (
              <NavButton
                ...
                onClick={() =>
                  onPageChange(item.id as "dashboard" | "inquiries" | "listing")
                }
              />
            ))}
          </nav>
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    <Avatar className="w-8 h-8">
                      <AvatarImage src="https://images.unsplash.com/photo-1494790108755-2616bde59a10?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=96&w=96" />
